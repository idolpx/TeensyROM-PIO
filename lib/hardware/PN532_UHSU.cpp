...
int8_t PN532_UHSU::writeCommand (const uint8_t *header, uint8_t hlen, const uint8_t *body, uint8_t blen)
{
...
int16_t PN532_UHSU::readResponse (uint8_t buf[], uint8_t len, uint16_t timeout)
{
    uint8_t tmp[3];
...
int8_t PN532_UHSU::readAckFrame()
{
